  ...
  curl -kL -o  /tmp/entrypoint1.sh "https://raw.githubusercontent.com/yzqiang666/mydoc/main/entrypoint_ql.sh"
  [ ! $? == 0 ] &&   curl -kL -o  /tmp/entrypoint1.sh "https://raw.githubusercontent.com/yzqiang666/mydoc/main/entrypoint_ql.sh"
  [ ! $? == 0 ] &&   curl -kL -o  /tmp/entrypoint1.sh "https://raw.githubusercontent.com/yzqiang666/mydoc/main/entrypoint_ql.sh"
  [ ! $? == 0 ] &&   curl -kL -o  /tmp/entrypoint1.sh "https://raw.githubusercontent.com/yzqiang666/mydoc/main/entrypoint_ql.sh"
